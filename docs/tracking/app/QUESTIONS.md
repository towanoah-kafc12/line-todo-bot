...
| Q-APP-004 | リッチメニューから section ごとの表示、追加、削除、編集をどう出し分けるか | Closed | - | action 数の制限、操作導線、誤タップ率、実装複雑度のバランスを決める必要があるため | `docs/ARCHITECTURE.md`, `docs/TASKS.md` | 2026-04-15 に `操作選択 -> section 選択` 導線を採用して実装完了。room 単位出し分けは将来候補として Q-APP-005 以降で継続 |
